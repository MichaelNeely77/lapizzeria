...
add_action('after_theme_setup', 'lapizzeria_custom_logo');
...
function lapizzeria_styles() {
	...
	wp_register_script('fluidboxjs', get_template_directory_uri() . '/js/jquery.fluidbox.min.js', array('jquery'), '', true );
